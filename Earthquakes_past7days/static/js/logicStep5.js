// Add console.log to check our code is working.
console.log("Working!");
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
    // This function returns style data for each earthquake plotted on map.
    // We pass the magnitude of the earthquake into 2 functions to calculate color & radius.
    ...
    // This function determines radius of earthquake marker based on its magnitude.
